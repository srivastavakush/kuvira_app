...
const styles = StyleSheet.create({
  ...
  h1: { color: colors.onSurface, fontSize: font.sizes.xxl, fontWeight: '800', marginBottom: spacing.xs, letterSpacing: -0.3 },
  ...
  opt: { paddingHorizontal: spacing.lg, height: 40, justifyContent: 'center', borderRadius: radius.pill, backgroundColor: colors.surfaceSecondary },
  optActive: { backgroundColor: colors.onSurface },
  optText: { color: colors.onSurfaceSecondary, fontSize: font.sizes.sm, fontWeight: '500' },
  optTextActive: { color: colors.surface, fontWeight: '700' },
  bigOpt: { padding: spacing.lg, borderRadius: radius.md, backgroundColor: colors.surfaceSecondary, marginBottom: spacing.sm },
  bigOptActive: { backgroundColor: colors.surfaceTertiary },
  bigOptText: { color: colors.onSurface, fontSize: font.sizes.base, fontWeight: '500' },
  bigOptTextActive: { color: colors.onSurface, fontWeight: '700' },
