...
export default function FacilityDetail() {
  ...
  async function load() { setError(null); try { setF(await api.facility(String(id))); } catch(e) { setError(e); } }
  useEffect(() => { load(); }, [id]);
